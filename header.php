    ...
    <nav id="menu" aria-label="Essensplan-Navigation">
        <ul>
            ...
            <li class="menu-group">
                ...
                <ul class="submenu">
                    <li><a href="/checker/">Website Checker</a></li><li><a href="/essensplan/">Essensplan</a></li><li><a href="/password/">Passwort-Generator</a></li><li><a href="/swiss-business-checker/">Swiss Business Checker</a></li><li><a href="/cve-watch-demo/">CVE Watch Demo</a></li><li><a href="/cnc/">Mini CNC Studio</a></li><li><a href="/tracks/">Tracks</a></li>
                </ul>
            </li>
            <?php if ($userLoggedIn): ?>
                <?php if ($isAdmin): ?>
